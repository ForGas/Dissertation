...
namespace Dissertation.Migrations
{
    ...
    [Migration("20220528201859_FeatPlannedResponsePlan")]
    partial class FeatPlannedResponsePlan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dissertation.Persistence.Entities.FileIncident", b =>
                {
                    ...
                    b.Property<bool>("IsVirusHashInfoClean")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Dissertation.Persistence.Entities.VirusHashInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VirusHashInfo", (string)null);
                });
            ...
            modelBuilder.Entity("RespondentJobSampleStaffStatistic", b =>
                {
                    b.Property<Guid>("JobSamplesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("StaffStatisticsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("JobSamplesId", "StaffStatisticsId");

                    b.HasIndex("StaffStatisticsId");

                    b.ToTable("RespondentJobSampleStaffStatistic");
                });
            ...
            modelBuilder.Entity("RespondentJobSampleStaffStatistic", b =>
                {
                    b.HasOne("Dissertation.Persistence.Entities.RespondentJobSample", null)
                        .WithMany()
                        .HasForeignKey("JobSamplesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dissertation.Persistence.Entities.StaffStatistic", null)
                        .WithMany()
                        .HasForeignKey("StaffStatisticsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
